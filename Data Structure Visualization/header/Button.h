...
public:
    ...
    InputBox(float x, float y, int maxCh) : Button({ x, y, x, y }, MAROON, LIGHTGRAY, DARKGRAY), inputText(""), Texting(false), lastDeletedTime(0), maxChars(maxCh), framesCounter(0) {
...
public:
    ...
    TextBox(Rectangle r, std::string t) : Text(t), Button(r) {}
    TextBox(Rectangle r, std::string t, Color tc, Color fc, Color olc) : Text(t), Button(r, tc, fc, olc) {}
